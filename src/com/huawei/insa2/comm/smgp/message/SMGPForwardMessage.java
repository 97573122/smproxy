...
public class SMGPForwardMessage extends SMGPMessage {
	...
	public SMGPForwardMessage(byte msgId[], String destSMGWNo, String srcSMGWNo, String smcNo, int msgType,
			int reportFlag, int priority, String serviceId, String feeType, String feeCode, String fixedFee,
			int msgFormat, Date validTime, Date atTime, String srcTermId, String destTermId, String chargeTermId,
			String msgContent, String reserve) throws IllegalArgumentException {
		if (msgId == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":MsgID ").append(SMGPConstant.STRING_NULL))));
		if (msgId.length > 10)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":MsgID ").append(SMGPConstant.STRING_LENGTH_GREAT).append("10"))));
		if (destSMGWNo == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":DestSMGWNo ").append(SMGPConstant.STRING_NULL))));
		if (destSMGWNo.length() > 6)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":DestSMGWNo ").append(SMGPConstant.STRING_LENGTH_GREAT).append("6"))));
		if (srcSMGWNo == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":SrcSMGWNo ").append(SMGPConstant.STRING_NULL))));
		if (srcSMGWNo.length() > 6)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":SrcSMGWNo ").append(SMGPConstant.STRING_LENGTH_GREAT).append("6"))));
		if (smcNo == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":SMCNo ").append(SMGPConstant.STRING_NULL))));
		if (smcNo.length() > 6)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":SMCNo ").append(SMGPConstant.STRING_LENGTH_GREAT).append("6"))));
		if (msgType < 0 || msgType > 255)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":MsgType ").append(SMGPConstant.INT_SCOPE_ERROR))));
		if (reportFlag < 0 || reportFlag > 255)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":ReportFlag ").append(SMGPConstant.INT_SCOPE_ERROR))));
		if (priority < 0 || priority > 9)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":").append(SMGPConstant.PRIORITY_ERROR))));
		if (serviceId == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":ServiceID ").append(SMGPConstant.STRING_NULL))));
		...
		if (feeType == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":FeeType ").append(SMGPConstant.STRING_NULL))));
		if (feeType.length() > 2)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
		...
		if (feeCode == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":FeeCode ").append(SMGPConstant.STRING_NULL))));
		if (feeCode.length() > 6)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
		...
		if (fixedFee == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":FixedFee ").append(SMGPConstant.STRING_NULL))));
		...
		if (msgFormat < 0 || msgFormat > 255)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":MsgFormat ").append(SMGPConstant.INT_SCOPE_ERROR))));
		if (srcTermId == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":SrcTermID ").append(SMGPConstant.STRING_NULL))));
		...
		if (destTermId == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":DestTermId ").append(SMGPConstant.STRING_NULL))));
		if (destTermId.length() > 21)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":DestTermId ").append(SMGPConstant.STRING_LENGTH_GREAT).append("21"))));
		if (chargeTermId == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":ChargeTermID ").append(SMGPConstant.STRING_NULL))));
		...
		if (msgContent == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.FORWARD_INPUT_ERROR))))
							.append(":MsgContent ").append(SMGPConstant.STRING_NULL))));
