...
public class SGIPBindMessage extends SGIPMessage {
	...
	public SGIPBindMessage(int login_Type, String login_Name, String login_Password) throws IllegalArgumentException {
		if (login_Name == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.CONNECT_INPUT_ERROR))))
							.append(":login_Name").append(SGIPConstant.STRING_NULL))));
		if (login_Name.length() > 16)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.CONNECT_INPUT_ERROR))))
							.append(":login_Name").append(SGIPConstant.STRING_LENGTH_GREAT).append("16"))));
		if (login_Password == null)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.CONNECT_INPUT_ERROR))))
							.append(":login_Password").append(SGIPConstant.STRING_NULL))));
		if (login_Password.length() > 16)
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.CONNECT_INPUT_ERROR))))
							.append(":login_Password").append(SGIPConstant.STRING_LENGTH_GREAT).append("16"))));
		if (login_Type < 0 || login_Type > 255) {
			throw new IllegalArgumentException(String.valueOf(
					String.valueOf((new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.CONNECT_INPUT_ERROR))))
							.append(":login_Type").append(SGIPConstant.INT_SCOPE_ERROR))));
		} else {
			int len = 61;
