...
public class SGIPBindRepMessage extends SGIPMessage {
	...
	public SGIPBindRepMessage(int result) throws IllegalArgumentException {
		if (result < 0 || result > 255) {
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.DELIVER_REPINPUT_ERROR))))
