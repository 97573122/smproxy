...
public class SMGPMtRouteUpdateMessage extends SMGPMessage {
	...
	public SMGPMtRouteUpdateMessage(int updateType, int routeId, String srcGatewayId, String srcGatewayIP,
			int srcGatewayPort, String startTermId, String endTermId, String areaCode) throws IllegalArgumentException {
		if (updateType < 0 || updateType > 255)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":UpdateType ").append(SMGPConstant.INT_SCOPE_ERROR))));
		if (srcGatewayId == null)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":SrcGatewayId ").append(SMGPConstant.STRING_NULL))));
		if (srcGatewayId.length() > 6)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":SrcGatewayId ").append(SMGPConstant.STRING_LENGTH_GREAT).append("6"))));
		if (srcGatewayIP == null)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":SrcGatewayIP ").append(SMGPConstant.STRING_NULL))));
		if (srcGatewayIP.length() > 15)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":SrcGatewayIP ").append(SMGPConstant.STRING_LENGTH_GREAT).append("15"))));
		if (startTermId == null)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":StartTermId ").append(SMGPConstant.STRING_NULL))));
		if (startTermId.length() > 6)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":StartTermId ").append(SMGPConstant.STRING_LENGTH_GREAT).append("6"))));
		if (endTermId == null)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":EndTermId ").append(SMGPConstant.STRING_NULL))));
		if (endTermId.length() > 6)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":EndTermId ").append(SMGPConstant.STRING_LENGTH_GREAT).append("6"))));
		if (areaCode == null)
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":AreaCode ").append(SMGPConstant.STRING_NULL))));
		if (areaCode.length() > 4) {
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SMGPConstant.MTROUTEUPDATE_INPUT_ERROR))))
							.append(":AreaCode ").append(SMGPConstant.STRING_LENGTH_GREAT).append("4"))));
		} else {
			int len = 56;
			buf = new byte[len];
