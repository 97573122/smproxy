...
public class SGIPSubmitMessage extends SGIPMessage {
	 ...
	 *            保留，扩展用
	 */
	public SGIPSubmitMessage(String SPNumber, // SP的接入号码
			...
			int FeeType, // 计费类型
			/*
			 * 用户计费类别 描述 0 "短消息类型"为"发送"，对"计费用户号码"不计信息费，此类话单仅用于核减SP对称的信道费 1
			 * 对"计费用户号码"免费 2 对"计费用户号码"按条计信息费 3 对"计费用户号码"按包月收取信息费 4
			 * 对"计费用户号码"的收费是由SP实现
			 */
			...
			/*
			 * 0-MO点播引起的第一条MT消息； 1-MO点播引起的非第一条MT消息； 2-非MO点播引起的MT消息；
