...
public class SGIPUserReportMessage extends SGIPMessage {
	...
	public String toString() {
		...
		tmpStr = String.valueOf(String.valueOf(
				(new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",SPNumber=").append(getSPNumber())));
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr))))
				.append(",UserNumber=").append(getUserNumber())));
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr))))
				.append(",UserCondition=").append(getUserCondition())));
		tmpStr = String.valueOf(String.valueOf(
