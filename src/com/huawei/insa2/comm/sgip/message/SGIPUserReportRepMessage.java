...
public class SGIPUserReportRepMessage extends SGIPMessage {
	...
	public SGIPUserReportRepMessage(int result) throws IllegalArgumentException {
		if (result < 0 || result > 255) {
			throw new IllegalArgumentException(String.valueOf(String
					.valueOf((new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.USERREPORT_REPINPUT_ERROR))))
							.append(":result").append(SGIPConstant.INT_SCOPE_ERROR))));
		} else {
			int len = 29;
