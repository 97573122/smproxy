...
public class SMGPQueryRespMessage extends SMGPMessage {
	...
	public SMGPQueryRespMessage(byte buf[]) throws IllegalArgumentException {
	...
	public String toString() {
		...
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr))))
				.append(",Time=").append(dateFormat.format(getTime()))));
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr))))
				.append(",AuthenticatorISMG=").append(getQueryType())));
		tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr))))
				.append(",QueryCode=").append(getQueryCode())));
		...
		tmpStr = String.valueOf(String.valueOf(
				(new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MtWt=").append(getMtWt())));
		tmpStr = String.valueOf(String.valueOf(
				(new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MtFl=").append(getMtFl())));
		tmpStr = String.valueOf(String.valueOf(
				(new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MoScs=").append(getMoScs())));
		tmpStr = String.valueOf(String.valueOf(
				(new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MoWt=").append(getMoWt())));
		tmpStr = String.valueOf(String.valueOf(
				(new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MoFl=").append(getMoFl())));
		tmpStr = String.valueOf(String.valueOf(
				(new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",Reverse=").append(getReserve())));
		return tmpStr;
	}
